...
public final class NotificationDao_Impl implements NotificationDao {
  ...
  public NotificationDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNotificationEntity = new EntityInsertionAdapter<NotificationEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notifications` (`id`,`title`,`content`,`type`,`activity_id`,`is_read`,`created_at`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfNotificationEntity = new EntityDeletionOrUpdateAdapter<NotificationEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `notifications` SET `id` = ?,`title` = ?,`content` = ?,`type` = ?,`activity_id` = ?,`is_read` = ?,`created_at` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfMarkAllAsRead = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE notifications SET is_read = 1";
        return _query;
      }
    };
      ...
      public List<NotificationEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new NotificationEntity(_tmpId,_tmpTitle,_tmpContent,_tmpType,_tmpActivityId,_tmpIsRead,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Flow<List<NotificationEntity>> getUnreadNotifications() {
    final String _sql = "SELECT * FROM notifications WHERE is_read = 0 ORDER BY created_at DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"notifications"}, new Callable<List<NotificationEntity>>() {
      @Override
      @NonNull
  ...
  public Flow<Integer> getUnreadCount() {
    final String _sql = "SELECT COUNT(*) FROM notifications WHERE is_read = 0";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  @Override
  public Object getNotificationById(final int id,
      ...
      public NotificationEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new NotificationEntity(_tmpId,_tmpTitle,_tmpContent,_tmpType,_tmpActivityId,_tmpIsRead,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
